        ...
        <div class="box-body no-padding">
          <form>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sep-edicion aumento-2">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-lg-offset-2 centrado text-edit-1 sep-media-edit">
                <p>TEXTO DESCRIPTIVO</p>
                  <input type="text" name="descripcion">
              </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sep-edicion aumento-2">
              <div class="col-xs-12 col-sm-6 col-sm-offset-6 col-md-6 col-lg-6 col-lg-offset-2  centrado text-edit-1">
      ...
      <input type='file' id="upload"></label>
             ...
             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 aumento3 margin-media">
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 ">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 ">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 centrado separacion-btnfile media-servicios">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 centrado text-edit-1">
                      <p>TITULO</p>
                        <input type="text" name="servicio-texto1">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 centrado text-edit-1 aumento-2">
                      <p>TEXTO DESCRIPTIVO</p>
                      <textarea name="servicio-texto2" class="text-area"></textarea>
                    </div>                   
                  </div>

                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 sep-media-edit">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 centrado separacion-btnfile media-servicios">
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 margin-media">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 aumento3">
           ...
           <form>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sep-edicion aumento-2">
              <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-lg-6 col-lg-offset-2  centrado text-edit-1">
                <p><span>URL</span> DE VIDEO</p>
                  <input type="text" name="url-video" class="marco-azul">
              </div>
            </div>
      ...
      <div class="modal fade" id="enviarInvitacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog content-popoup size-modal" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body col-sm-12 col-md-12" style="background:white;">
              <!--COLLAPSER-->
                <div class="col-md-12">
                  ...
                  <!-- redes url -->
                   <form action="">
                  <div class=" col-sm-10 col-sm-offset-1 col-md-12 col-lg-12">
