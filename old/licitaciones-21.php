...
<div class="content-wrapper">
  <section>
    <div class="container-fluid nomargin">
      <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 titulo-perfil">
        <p>
          LICITACIONES
        </p>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 top-50">
        <div class="col-md-3  col-sm-3 col-xs-12 margen-xs">
          <div class="dropdown boton-categoria2">
            ...
            <div class="dropdown-menu content-drop-xs" aria-labelledby="dropdownMenuButton">
      ...
      <div class="col-md-12 col-xs-12 dotted-down">
        <div class="col-md-1 col-sm-1 centers">
        ...
        <div class="col-md-2 col-sm-3 nomargin">
        ...
        <div class="col-md-2 col-sm-4 col-false nomargin">
          <p class="top-5"><strong>Fecha:</strong> Hace 1 minuto</p>
        </div>
        <div class="col-md-1 col-sm-4 nomargin">
