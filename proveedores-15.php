          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sinpadding-lic">
              ...
              <div class="box-body no-padding">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mailbox-controls">  
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-10 col-lg-10 dropdown boton-categoria sinpadding-lic">
 ...
 <!--Empieza titulos-->
      <div class="col-md-12 col-sm-12 col-xs-12 confirma dotted-down centrado">
        <div class="col-md-3 col-sm-1 col-xs-5">
          <p>
            <strong class="texto-content">SOLICITANTE / CATEGORIA</strong>
          </p>
        </div> 
        <div class="col-md-3 col-sm-1 col-xs-3">
          <p>
            <strong class="texto-content">EMVIADO A / CATEGORÍA</strong>
          </p>
        </div>
...
<?php  for ($i=0; $i <5 ; $i++) { ?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 dotted-down centrado">
        ...
        <div class="col-md-2 col-sm-2 col-xs-6 nomargin centrar separacion-list">
          <span class="device-title">USUARIO<br></span>
          <span class="texto-content">Lorena Ipsum / fashion</span>         
        </div>
